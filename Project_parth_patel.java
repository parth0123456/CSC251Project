...
{ // Open the Class Container  
   ...
   { // Open the Main Method
      ...
      { // Open Loop
         ...
         PolicyHolder policyHolder = new PolicyHolder(firstName, lastName, holderAge, smokingStatus, holderHeight, holderWeight);
            
         Policy p = new Policy(providerName, policyNum, policyHolder);
